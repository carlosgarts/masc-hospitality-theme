...
<div class="cover-greeting">
    <div class="m-c-image">
        <video id="masked-video" autoplay playsinline muted loop preload poster="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/oceanshot.jpg">
            <source src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/ocean-small.webm" />
        </video>
        <svg version="1.1" id="video-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                viewBox="0 0 146.4 72" style="enable-background:new 0 0 146.4 59.4;" xml:space="preserve" overflow="visible">
            <style type="text/css">
                .st0{fill:#FFFFFF;}
            </style>
            <defs>
            ...
            <rect class='covertor' x="0" y="0" width="100%" height="100%" />
        </svg>
    </div>
    <p class="m-c-paragraph">
        NYC-based hospitality group that creates and operates festivals and brands focused on the love-to-eat community
    </p>
</div>